use divan::black_box;
use primality::{
    bigint_miller_rabin, miller_list, mult_prime, sieve, solovay_strassen_list,
    threaded_miller_rabin, wheel_mult_prime, u64AKS
};
use rug::Integer;
...
fn bigint_miller_primes(arg: &Integer) {
    black_box(bigint_miller_rabin(black_box(arg.clone()), 10));
}
