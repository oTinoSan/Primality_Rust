...
fn main() {
    ...
    let threaded_primes = primality_tests::bigint_algorithms::wheel_threaded::general_wheel_threaded(10, Integer::ZERO, max.clone(), 4, primality_tests::bigint_algorithms::miller_rabin, vec![2, 3, 5], vec![1, 7, 11, 13, 17, 19, 23, 29]);
